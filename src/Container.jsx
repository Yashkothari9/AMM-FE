        ...
        <div className = "centerBody">
            <div className = "centerContainer">
                <div className="selectTab">
                    <div className ={"tabStyle " + (activeTab === "Swap" ? "activeTab" : "")} onClick = {() => changeTab("Swap")}>Swap</div>
                    <div className ={"tabStyle " + (activeTab === "Provide" ? "activeTab" : "")} onClick = {() => changeTab("Provide")}>Provide</div>
                    <div className ={"tabStyle " + (activeTab === "Withdraw" ? "activeTab" : "")} onClick = {() => changeTab("Withdraw")}>Withdraw</div>
                    <div className ={"tabStyle " + (activeTab === "Faucet" ? "activeTab" : "")} onClick = {() => changeTab("Faucet")}>Faucet</div>
                </div>

                { activeTab === "Swap" && <SwapComponent contract = {props.contract} getHoldings = {() => getHoldings()}/>}
                { activeTab === "Provide" && <ProvideComponent contract = {props.contract} getHoldings = {() => getHoldings()}/>}
                { activeTab === "Withdraw" && <WithdrawComponent contract = {props.contract} maxShare = {amountOfShare} getHoldings = {() => getHoldings()}/>}
                { activeTab === "Faucet" && <FaucetComponent contract = {props.contract} getHoldings = {() => getHoldings()}/>}
            </div>
